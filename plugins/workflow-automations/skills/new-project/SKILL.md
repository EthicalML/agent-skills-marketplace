...
Show the document to the user and correct misunderstandings. Commit this document alone with a comprehensive conventional commit, such as `docs(rpi): capture initial request for <name>`.
