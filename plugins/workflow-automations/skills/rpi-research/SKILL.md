...
Read `adrs/000-initial-request.md`, then inspect `research/` and relevant repository code. Summarize what exists and offer the next unfinished step. If the user does not choose it, stop.
