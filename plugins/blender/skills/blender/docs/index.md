...
| --- | --- | --- |
| Match proportions against a 3D reference or compare checkpoints | [Reference-model comparison](reference-comparison.md) | Local blend checkpoint pair tested; external matching depends on acquisition |
